...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = peripherals_0_axi_quad_spi_badc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = peripherals_0_axi_quad_spi_disp
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.10
 PARAMETER HW_INSTANCE = peripherals_0_axi_uartlite_esp
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.10
 PARAMETER HW_INSTANCE = peripherals_0_axi_uartlite_pmc
END
