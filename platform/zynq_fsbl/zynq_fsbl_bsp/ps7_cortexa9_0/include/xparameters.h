...
/* Definitions for peripheral AXI_DMA_DSP_SPI */
#define XPAR_AXI_DMA_DSP_SPI_DEVICE_ID 0
#define XPAR_AXI_DMA_DSP_SPI_BASEADDR 0x40410000
#define XPAR_AXI_DMA_DSP_SPI_HIGHADDR 0x4041FFFF
#define XPAR_AXI_DMA_DSP_SPI_SG_INCLUDE_STSCNTRL_STRM 0
#define XPAR_AXI_DMA_DSP_SPI_INCLUDE_MM2S_DRE 0
#define XPAR_AXI_DMA_DSP_SPI_INCLUDE_S2MM_DRE 0
#define XPAR_AXI_DMA_DSP_SPI_INCLUDE_MM2S 1
#define XPAR_AXI_DMA_DSP_SPI_INCLUDE_S2MM 0
#define XPAR_AXI_DMA_DSP_SPI_M_AXI_MM2S_DATA_WIDTH 32
#define XPAR_AXI_DMA_DSP_SPI_M_AXI_S2MM_DATA_WIDTH 32
#define XPAR_AXI_DMA_DSP_SPI_INCLUDE_SG 0
#define XPAR_AXI_DMA_DSP_SPI_ENABLE_MULTI_CHANNEL 0
#define XPAR_AXI_DMA_DSP_SPI_NUM_MM2S_CHANNELS 1
#define XPAR_AXI_DMA_DSP_SPI_NUM_S2MM_CHANNELS 1
#define XPAR_AXI_DMA_DSP_SPI_MM2S_BURST_SIZE 16
#define XPAR_AXI_DMA_DSP_SPI_S2MM_BURST_SIZE 16
#define XPAR_AXI_DMA_DSP_SPI_MICRO_DMA 0
#define XPAR_AXI_DMA_DSP_SPI_ADDR_WIDTH 32
#define XPAR_AXI_DMA_DSP_SPI_SG_LENGTH_WIDTH 14


/* Definitions for peripheral AXI_DMA_PMC_UART */
#define XPAR_AXI_DMA_PMC_UART_DEVICE_ID 1
#define XPAR_AXI_DMA_PMC_UART_BASEADDR 0x40400000
#define XPAR_AXI_DMA_PMC_UART_HIGHADDR 0x4040FFFF
#define XPAR_AXI_DMA_PMC_UART_SG_INCLUDE_STSCNTRL_STRM 0
#define XPAR_AXI_DMA_PMC_UART_INCLUDE_MM2S_DRE 0
#define XPAR_AXI_DMA_PMC_UART_INCLUDE_S2MM_DRE 0
#define XPAR_AXI_DMA_PMC_UART_INCLUDE_MM2S 1
#define XPAR_AXI_DMA_PMC_UART_INCLUDE_S2MM 1
#define XPAR_AXI_DMA_PMC_UART_M_AXI_MM2S_DATA_WIDTH 32
#define XPAR_AXI_DMA_PMC_UART_M_AXI_S2MM_DATA_WIDTH 32
#define XPAR_AXI_DMA_PMC_UART_INCLUDE_SG 0
#define XPAR_AXI_DMA_PMC_UART_ENABLE_MULTI_CHANNEL 0
#define XPAR_AXI_DMA_PMC_UART_NUM_MM2S_CHANNELS 1
#define XPAR_AXI_DMA_PMC_UART_NUM_S2MM_CHANNELS 1
#define XPAR_AXI_DMA_PMC_UART_MM2S_BURST_SIZE 16
#define XPAR_AXI_DMA_PMC_UART_S2MM_BURST_SIZE 16
#define XPAR_AXI_DMA_PMC_UART_MICRO_DMA 0
#define XPAR_AXI_DMA_PMC_UART_ADDR_WIDTH 32
#define XPAR_AXI_DMA_PMC_UART_SG_LENGTH_WIDTH 14


/******************************************************************/

/* Canonical definitions for peripheral AXI_DMA_DSP_SPI */
#define XPAR_AXIDMA_0_DEVICE_ID XPAR_AXI_DMA_DSP_SPI_DEVICE_ID
...
/* Canonical definitions for peripheral AXI_DMA_PMC_UART */
#define XPAR_AXIDMA_1_DEVICE_ID XPAR_AXI_DMA_PMC_UART_DEVICE_ID
...
/* Definitions for peripheral PERIPHERALS_0_AXI_GPIO_0 */
#define XPAR_PERIPHERALS_0_AXI_GPIO_0_BASEADDR 0x41200000
#define XPAR_PERIPHERALS_0_AXI_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_PERIPHERALS_0_AXI_GPIO_0_DEVICE_ID 0
#define XPAR_PERIPHERALS_0_AXI_GPIO_0_INTERRUPT_PRESENT 1
#define XPAR_PERIPHERALS_0_AXI_GPIO_0_IS_DUAL 1


/* Definitions for peripheral SENSOR_0_AXI_GPIO_0 */
#define XPAR_SENSOR_0_AXI_GPIO_0_BASEADDR 0x41210000
#define XPAR_SENSOR_0_AXI_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_SENSOR_0_AXI_GPIO_0_DEVICE_ID 1
#define XPAR_SENSOR_0_AXI_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_SENSOR_0_AXI_GPIO_0_IS_DUAL 1


/******************************************************************/

/* Canonical definitions for peripheral PERIPHERALS_0_AXI_GPIO_0 */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_PERIPHERALS_0_AXI_GPIO_0_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 1
#define XPAR_GPIO_0_IS_DUAL 1

/* Canonical definitions for peripheral SENSOR_0_AXI_GPIO_0 */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_SENSOR_0_AXI_GPIO_0_DEVICE_ID
...
#define XPAR_FABRIC_PERIPHERALS_0_AXI_GPIO_0_IP2INTC_IRPT_INTR 61U
#define XPAR_FABRIC_PERIPHERALS_0_AXI_QUAD_SPI_0_IP2INTC_IRPT_INTR 62U
#define XPAR_FABRIC_PERIPHERALS_0_AXI_QUAD_SPI_1_IP2INTC_IRPT_INTR 63U
#define XPAR_FABRIC_AXI_DMA_PMC_UART_MM2S_INTROUT_INTR 66U
#define XPAR_FABRIC_AXI_DMA_PMC_UART_S2MM_INTROUT_INTR 67U
#define XPAR_FABRIC_AXI_DMA_DSP_SPI_MM2S_INTROUT_INTR 68U

/******************************************************************/

/* Canonical definitions for Fabric interrupts connected to ps7_scugic_0 */
#define XPAR_FABRIC_GPIO_0_VEC_ID XPAR_FABRIC_PERIPHERALS_0_AXI_GPIO_0_IP2INTC_IRPT_INTR
#define XPAR_FABRIC_SPI_0_VEC_ID XPAR_FABRIC_PERIPHERALS_0_AXI_QUAD_SPI_0_IP2INTC_IRPT_INTR
#define XPAR_FABRIC_SPI_1_VEC_ID XPAR_FABRIC_PERIPHERALS_0_AXI_QUAD_SPI_1_IP2INTC_IRPT_INTR
#define XPAR_FABRIC_AXIDMA_1_MM2S_INTROUT_VEC_ID XPAR_FABRIC_AXI_DMA_PMC_UART_MM2S_INTROUT_INTR
#define XPAR_FABRIC_AXIDMA_1_S2MM_INTROUT_VEC_ID XPAR_FABRIC_AXI_DMA_PMC_UART_S2MM_INTROUT_INTR
#define XPAR_FABRIC_AXIDMA_0_VEC_ID XPAR_FABRIC_AXI_DMA_DSP_SPI_MM2S_INTROUT_INTR
...
/* Definitions for peripheral PERIPHERALS_0_AXI_QUAD_SPI_0 */
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_DEVICE_ID 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_BASEADDR 0x41E00000U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_HIGHADDR 0x41E0FFFFU
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_FIFO_EXIST 1U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_FIFO_DEPTH 16U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_SPI_SLAVE_ONLY 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_NUM_SS_BITS 1U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_NUM_TRANSFER_BITS 8U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_SPI_MODE 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_TYPE_OF_AXI4_INTERFACE 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_AXI4_BASEADDR 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_AXI4_HIGHADDR 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_0_XIP_MODE 0U

/* Canonical definitions for peripheral PERIPHERALS_0_AXI_QUAD_SPI_0 */
...
/* Definitions for peripheral PERIPHERALS_0_AXI_QUAD_SPI_1 */
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_DEVICE_ID 1U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_BASEADDR 0x41E10000U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_HIGHADDR 0x41E1FFFFU
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_FIFO_EXIST 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_FIFO_DEPTH 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_SPI_SLAVE_ONLY 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_NUM_SS_BITS 1U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_NUM_TRANSFER_BITS 8U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_SPI_MODE 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_TYPE_OF_AXI4_INTERFACE 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_AXI4_BASEADDR 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_AXI4_HIGHADDR 0U
#define XPAR_PERIPHERALS_0_AXI_QUAD_SPI_1_XIP_MODE 0U

/* Canonical definitions for peripheral PERIPHERALS_0_AXI_QUAD_SPI_1 */
