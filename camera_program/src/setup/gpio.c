...
void gpio_init()
{
     ...
     */
    XGpio_Config *CfgPtr = XGpio_LookupConfig(XPAR_PERIPHERALS_0_AXI_GPIO_0_BASEADDR);
    if (XGpio_Initialize(&fpga_gpio, XPAR_PERIPHERALS_0_AXI_GPIO_0_BASEADDR) != XST_SUCCESS)
    {
