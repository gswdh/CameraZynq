...
void gmax_init()
{
    ...
    log_info(LOG_TAG, "Starting sensor syncronisation.\n");
    gmax_sync(true);
    ...
    gpio_set(FPGA_LED_1);
    log_info(LOG_TAG, "Sensor stream locked.\n");
}